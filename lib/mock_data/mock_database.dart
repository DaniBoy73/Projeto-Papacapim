...
class MockDatabase {
  ...
  static UserModel loggedUser = UserModel(
    ...
    avatarUrl: 'https://ui-avatars.com/api/?name=Carlos+Silva&background=10B981&color=fff&size=150&bold=true',
    followersCount: 142,
    followingCount: 58,
    isCurrentUser: true,
  );
  ...
  static List<UserModel> getInitialUsers() {
    return [
      ...
      UserModel(
        ...
        name: 'Ana Dev',
        login: 'ana_dev',
        avatarUrl: 'https://ui-avatars.com/api/?name=Ana+Dev&background=6366F1&color=fff&size=150&bold=true',
        followersCount: 890,
        followingCount: 120,
      ...
      UserModel(
        ...
        avatarUrl: 'https://ui-avatars.com/api/?name=Marcos+Flutter&background=0EA5E9&color=fff&size=150&bold=true',
        followersCount: 340,
        followingCount: 95,
        isFollowedByCurrentUser: true,
      ),
      UserModel(
        ...
        name: 'Juliana Tech',
        login: 'juliana_tech',
        avatarUrl: 'https://ui-avatars.com/api/?name=Juliana+Tech&background=EC4899&color=fff&size=150&bold=true',
        followersCount: 1250,
        followingCount: 430,
  ...
  static List<PostModel> getInitialPosts() {
    ...
    return [
      PostModel(
        ...
        authorName: 'Ana Dev',
        authorLogin: 'ana_dev',
        authorAvatarUrl: 'https://ui-avatars.com/api/?name=Ana+Dev&background=6366F1&color=fff&size=150&bold=true',
      ...
      PostModel(
        ...
        authorAvatarUrl: 'https://ui-avatars.com/api/?name=Carlos+Silva&background=10B981&color=fff&size=150&bold=true',
      ...
      PostModel(
        ...
        authorAvatarUrl: 'https://ui-avatars.com/api/?name=Marcos+Flutter&background=0EA5E9&color=fff&size=150&bold=true',
      ...
      PostModel(
        ...
        authorAvatarUrl: 'https://ui-avatars.com/api/?name=Juliana+Tech&background=EC4899&color=fff&size=150&bold=true',
